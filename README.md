...
Use the view toggle in the top-right corner to cycle between the Aurora command center, compact Focus list, and bright Daylight desk. The selected view is remembered locally in your browser.
